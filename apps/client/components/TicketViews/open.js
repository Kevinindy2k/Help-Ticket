  ...
  const columns = React.useMemo(() => [
    ...
    },
    {
      ...
      Cell: ({ row, value }) => {
        ...
        return (
          <>
            <span className="max-w-[240px] truncate">{value}2</span>
          </>
        );
      },
    },
        ...
        return (
          <>
            <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
              ...
              {value === "accepted" && <span>accepted</span>}
              {value === "resolved" && <span>resolved</span>}
              {value === "rejected" && <span>rejected</span>}
            </span>
          </>
        );
      },
    },
    {
      ...
      id: "created",
      Cell: ({ row, value }) => {
        const now = moment(value).format("hh:mm DD-MM-YYYY");
        return (
          <>
